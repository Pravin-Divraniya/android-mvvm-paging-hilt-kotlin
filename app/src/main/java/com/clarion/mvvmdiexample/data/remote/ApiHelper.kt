...
import com.clarion.mvvmdiexample.utils.ApiUtils
import com.clarion.mvvmdiexample.utils.ConstantData
import com.clarion.mvvmdiexample.utils.ConstantData.IMAGE_UPLOAD_URL
...
class ApiHelper:IApiHelper {
    ...
    override fun uploadImageToServer(fileMap: MutableMap<String, File>,
            ...
            Rx2AndroidNetworking.upload(IMAGE_UPLOAD_URL)
                    ...
                    .setPriority(Priority.HIGH)
                    .build()
                    .setUploadProgressListener { bytesUploaded, totalBytes -> }//Use these both objects of type Long in order to calculate and show the progress.

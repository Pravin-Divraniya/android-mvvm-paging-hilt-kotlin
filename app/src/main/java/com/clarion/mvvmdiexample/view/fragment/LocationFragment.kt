...
import com.clarion.mvvmdiexample.receiver.LocationReceiver
...
class LocationFragment : Fragment() {
     ...
     */
    private var mPandingIntent:PendingIntent? = null
    ...
    fun requestLocationUpdates() {
        try {
            ...
            mPandingIntent = getPendingIntent()
    ...
    fun removeLocationUpdates() {
        if(null == mPandingIntent)
            return
        Log.i(TAG, "Removing location updates")
        mFusedLocationClient.removeLocationUpdates(mPandingIntent)
    }
